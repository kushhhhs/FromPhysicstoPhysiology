function [S,nodeStuck]=ThrombusFlowThrombolysis (S,thrombusRadius)
...
% this group 1 2024 version aims to include thrombolysis.
% Once a thrombus gets stuck, we add a counter. Outside of this routine,
% you can decrease the counter over time and once it gets to be zero we'll
% run a bit of code that removes the clot
...
while ~stuck
	...
	if isempty(ipossible)
		...
		S.IN(currentNode).ThrombusCounter=S.ThrombusCounterStart; 
